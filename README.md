...
Под кнопкой всегда есть подсказка, а после нажатия она выделяется заметным блоком:
«После скачивания внизу экрана браузера появится плашка «Открыть» — нажмите её и выберите ваше приложение календаря».
...
2. Внизу экрана браузера появится плашка о скачанном файле с кнопкой **«Открыть»** — нажмите её.
3. Выберите ваше приложение календаря → событие «Проверка» на завтра, 10:00. Удалите его.
...
- **Шаг времени — 5 минут** везде, где время выбирается по сетке: фишка «Время…» и карточка задачи,
  окончание, постоянные блоки, запись сессии, перетаскивание дела на ленту дня, начало свободных окон.
  В листе выбора времени каждый час — блок из двух рядов по 6 крупных кнопок (09:00, :05 … :55);
  сетка прокручивается, а полоска часов сверху (6 … 23) переносит к нужному часу одним касанием
  и показывает, какой час сейчас на экране. Открывается сетка на выбранном времени или на 9:00.
