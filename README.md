...
- **В карточке любой задачи с датой** (со временем или на весь день) и у задачи со сроком всегда есть
  кнопка **«Добавить в Яндекс.Календарь»**.
- **Сессия, записанная ассистентом**, — кнопка «Добавить в Яндекс.Календарь» на экране «Записано».
...
файле → выберите Яндекс.Календарь». Если уведомление уже смахнули — файл лежит в «Загрузках».
...
3. Смахните шторку → нажмите уведомление о файле → выберите Яндекс.Календарь → событие
...
**«Добавить в Яндекс.Календарь»**. Задачи без времени сами не предлагаются, но кнопка в карточке
